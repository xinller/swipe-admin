<template>
    <div class="login" @keydown.enter="handleSubmit">
        <div class="login-header">
            <div class="hd">
                <img src="../../assets/images/login/logo.png" class="logo" /> <span class="hd-title">找回密码</span>
            </div>
        </div>
        <div class="register-wrap forget">
                ...
                <a-card :bordered="false">
                    ...
                    <a-spin :spinning="spinning" class="form-con">
                        <a-form :form="loginForm" @submit="handleSubmit">
                            ...
                            <a-form-item prop="repassword">
                                <a-input
                                    size="large"
                                    :type="showPass2 ? 'text' : 'password'"
                                    v-decorator="rules.repassword"
                                    placeholder="请再次输入密码"
                                >
                                    <a-icon
                                        slot="suffix"
                            ...
                            <a-form-item>
                                <a-button size="large" type="primary" block html-type="submit">确定</a-button>
                            </a-form-item>
                        </a-form>
                    </a-spin>
                </a-card>
                ...
                repassword: [
                    'repassword',
                    {
                        rules: [
                            ...
                            { validator: validatePass2, message: '请再次输入密码' },
                        ],
                    },
                ],
        ...
        handleSubmit(e) {
            ...
            this.loginForm.validateFields((err, values) => {
                if (!err) {
                    ...
                    api.forgetLoginPass(values).then((res) => {
                        this.spinning = false
                        if (res.success) {
